<tr id="searchrow">
	<form class="form-horizontal" role="form" method="POST" action="?action=search">
		<th><input type="text"class="form-control" name="searchpatho" id="searchpatho" placeholder="search"></th>
		<th><input type="text"class="form-control" name="searchtype" id="searchtype" placeholder="search"></th>
